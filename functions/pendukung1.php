...
$PWK = mysqli_query($koneksi, "UPDATE counter_pendukung1 SET counter =
(select count(prodi) from user inner join voting ON voting.username = user.username
where kandidat_id = 1 and prodi = 'Perencanaan Wilayah dan Kota')where id = 'Perencanaan Wilayah dan Kota'");

$TG = mysqli_query($koneksi, "UPDATE counter_pendukung1 SET counter =
(select count(prodi) from user inner join voting ON voting.username = user.username
where kandidat_id = 1 and prodi = 'Teknik Geofisika') where id = 'Teknik Geofisika'");

$SI = mysqli_query($koneksi, "UPDATE counter_pendukung1 SET counter =
(select count(prodi) from user inner join voting ON voting.username = user.username
where kandidat_id = 1 and prodi = 'Teknik Sipil') where id = 'Teknik Sipil'");

$TL = mysqli_query($koneksi, "UPDATE counter_pendukung1 SET counter =
(select count(prodi) from user inner join voting ON voting.username = user.username
where kandidat_id = 1 and prodi = 'Teknik Lingkungan') where id = 'Teknik Lingkungan'");

$Geo = mysqli_query($koneksi, "UPDATE counter_pendukung1 SET counter =
(select count(prodi) from user inner join voting ON voting.username = user.username
where kandidat_id = 1 and prodi = 'Teknik Informatika') where id = 'Teknik Informatika'");

$ar = mysqli_query($koneksi, "UPDATE counter_pendukung1 SET counter =
(select count(prodi) from user inner join voting ON voting.username = user.username
where kandidat_id = 1 and prodi = 'Teknik Geologi') where id = 'Teknik Geologi'");
